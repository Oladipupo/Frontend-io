...
const fetchPieces = async () => {
  const url = "https://backend.oladipupo.io/api/v1/getart";
...
const fetchProjects$1 = async () => {
  const url = "https://backend.oladipupo.io/api/v1/getmusic";
  const res = await fetch(url);
  const data = await res.json();

...
var __layout_svelte_svelte_type_style_lang = ":root{background-color:#000;font-family:-apple-system,BlinkMacSystemFont,Segoe UI,Roboto,Oxygen,Ubuntu,Cantarell,Open Sans,Helvetica Neue,sans-serif,Courier New,monospace}.spacing.svelte-t4nk2{margin-top:300px}";
const css$b = {
...
var footer_svelte_svelte_type_style_lang = ".wrapper.svelte-1tjht53{align-items:center;background-color:#000;display:flex;height:125px;justify-content:center;width:100%}p.svelte-1tjht53{color:#fff;font-family:Courier New,monospace}";
const css$8 = {
...
var dbConnectionTest_svelte_svelte_type_style_lang = "button.svelte-y8fl7k{background-color:#000;border:.1em solid #fff;border-radius:.12em;box-sizing:border-box;color:#fff;display:inline-block;font-family:Courier New,monospace;font-weight:300;margin:0 .3em .3em 0;padding:.35em 1.2em;text-align:center;text-decoration:none;transition:all .2s}button.svelte-y8fl7k:hover{background-color:#fff;color:#000}h1.svelte-y8fl7k{color:#fff;font-family:Courier New,monospace}";
...
var contactme_svelte_svelte_type_style_lang = ".wrapper.svelte-1juvoyi{margin-top:5%}.sub.svelte-1juvoyi,.wrapper.svelte-1juvoyi{align-items:center;background-color:#000;display:flex;flex-wrap:wrap;justify-content:center;width:100%}h1.svelte-1juvoyi{font-size:70px}.colorText.svelte-1juvoyi,h1.svelte-1juvoyi{color:#fff;font-family:Courier New,Courier,monospace}.b.svelte-1juvoyi{background-color:#000;border:.1em solid #fff;border-radius:.12em;box-sizing:border-box;color:#fff;display:inline-block;font-family:Courier New,monospace;font-weight:300;margin:1% 70px 0;padding:.75em 1.2em;text-align:center;text-decoration:none;transition:all .2s;width:auto}.b.svelte-1juvoyi:hover{background-color:#fff;border:.3em solid #fff;color:#000}";
const css$6 = {
...
var socials_svelte_svelte_type_style_lang = ".wrapper.svelte-iwqrwu{align-items:center;background-color:#000;display:flex;justify-content:center;margin-top:5%;width:100%}a.svelte-iwqrwu{height:4%;margin-left:5%;margin-right:5%;transition:transform .3s cubic-bezier(.155,1.105,.295,1.12);width:4%}a.svelte-iwqrwu:hover{transform:scale(1.1)}";
const css$5 = {
...
var index_svelte_svelte_type_style_lang = "div.svelte-3mxne4{background-color:#000;margin:0 auto;min-height:1400px;text-align:center}";
const css$4 = {
...
var projects_svelte_svelte_type_style_lang = ".wrapper.svelte-x5yyi1{background-color:#000;display:flex;justify-content:center;padding-bottom:10%;width:100%}.card.svelte-x5yyi1:hover{box-shadow:0 10px 20px rgba(0,0,0,.12),0 4px 8px rgba(0,0,0,.06);transform:scale(1.05)}:root{background-color:#000;font-family:-apple-system,BlinkMacSystemFont,Segoe UI,Roboto,Oxygen,Ubuntu,Cantarell,Open Sans,Helvetica Neue,sans-serif,Courier New,monospace}";
const css$3 = {
...
var music_svelte_svelte_type_style_lang = ".wrapper.svelte-3xti9t{background-color:#000;display:flex;justify-content:center;padding-bottom:10%;width:100%}.card.svelte-3xti9t:hover{box-shadow:0 10px 20px rgba(0,0,0,.12),0 4px 8px rgba(0,0,0,.06);transform:scale(1.05)}:root{background-color:#000;font-family:-apple-system,BlinkMacSystemFont,Segoe UI,Roboto,Oxygen,Ubuntu,Cantarell,Open Sans,Helvetica Neue,sans-serif,Courier New,monospace}.sp.svelte-3xti9t{align-items:center;align-self:center;display:none;justify-content:center;opacity:0;transition:all .2s linear}";
const css$2 = {
...
var other_svelte_svelte_type_style_lang = "p.svelte-mmwkg4{color:#fff;font-family:Courier New,Courier,monospace}div.svelte-mmwkg4{align-items:center;background-color:#000;display:flex;height:125px;justify-content:center;width:100%}";
const css$1 = {
